...
class ShopModelTests(TestCase):
    ...
    def create_guest_order(self, **extra_fields):
        order_data = {
            "client_name": "Марія",
    ...
    def test_cosmetologist_receives_professional_price(self):
    ...
    def test_guest_cannot_buy_professional_product(self):
        order = self.create_guest_order()
    ...
    def test_cosmetologist_can_buy_professional_product(self):
        cosmetologist = get_user_model().objects.create_user(
    ...
    def test_cancelling_paid_order_restores_stock(self):
        order = self.create_guest_order(
    ...
    def test_order_without_payment_method_cannot_be_paid(self):
        order = self.create_guest_order()
